...
//unsigned long TIME_INTERVAL_ALIVE_KLINE = 2000;
...
void setup() {
  Serial.begin(115200);
  //Serial2.begin(115200, SERIAL_8N1, RxKline, TxKline);

  pinMode(TxKline, OUTPUT);
  // pinMode(RxKline, INPUT);
  ...
  //add handler for root (/) webserver directory:
